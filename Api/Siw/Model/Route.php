 ...
 *
 * @category Class
 * @description A route represents a list of delivery steps for a chained delivery.
 * @package  Ingrid
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class Route implements ModelInterface, ArrayAccess {
    ...
    protected static $swaggerTypes = [
        'id' => 'string',
        'shipping_legs' => '\Ingrid\Checkout\Api\Siw\Model\ShippingLeg[]',    ];
    ...
    public function __construct(array $data = null) {
        ...
        $this->container['shipping_legs'] = isset($data['shipping_legs']) ? $data['shipping_legs'] : null;
    }
     ...
     * Gets shipping_legs
     *
     * @return \Ingrid\Checkout\Api\Siw\Model\ShippingLeg[]
     */
     ...
     * Sets shipping_legs
     *
     * @param \Ingrid\Checkout\Api\Siw\Model\ShippingLeg[] $shipping_legs ShippingLegs represent a list of delivery steps.
     *
     * @return $this
     */
