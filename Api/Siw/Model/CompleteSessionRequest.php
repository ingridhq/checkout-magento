 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CompleteSessionRequest implements ModelInterface, ArrayAccess {
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CompleteSessionRequest';
     ...
     * Sets warehouse_id
     *
     * @param string $warehouse_id Warehouse ID specifies from which warehouse order will be sent. If it is not supplied and site has only one warehouse, this warehouse will be used as sender. Otherwise order will have no sender address.
     *
     * @return $this
     */
